...
let s:pink        = { "gui": "#db5b5b", "cterm": "1" }
let s:green       = { "gui": "#2eb398", "cterm": "2" }
let s:aqua        = { "gui": "#b5e4f4", "cterm": "4" }
let s:blue        = { "gui": "#4ea2c1", "cterm": "6" }
let s:yellow      = { "gui": "#f0c07e", "cterm": "3" }
let s:orange      = { "gui": "#d28445", "cterm": "16" }
let s:purple      = { "gui": "#b56ea7", "cterm": "5" }
let s:red         = { "gui": "#db5b5b", "cterm": "1" }
let s:darkred     = { "gui": "#8f5536", "cterm": "17" }
...
" popup menu
call s:h("Pmenu",         { "fg": s:white,      "bg": s:darkgrey })
call s:h("PmenuSel",      { "fg": s:green,       "bg": s:darkgrey,      "format": "bold" })
